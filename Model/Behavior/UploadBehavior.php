 ...
 */
	protected function _prepareToWriteFiles($model, $field) {
		...
		$model->data[$model->name][$this->toWrite[$field]['settings']['fields']['size']] = $this->toWrite[$field]['size'];
		$model->data[$model->name][$this->toWrite[$field]['settings']['fields']['extension']] = $extension;
		$model->data[$model->name][$this->toWrite[$field]['settings']['fields']['mime_type']] = $this->toWrite[$field]['type'];
	}
